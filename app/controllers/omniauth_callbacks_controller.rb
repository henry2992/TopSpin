  ...
  def facebook
    ...
    if @player.persisted?
      ...
      if ((Date.today.mjd - @player.last_sign_in_at.to_date.mjd) < 0 )
        ...
        message = 'Welcome back! It’s been ' + (Date.today.mjd - current_player.last_sign_in_at.to_date.mjd ) + ' days since you last completed an activity. Let’s go play some tennis!'
      end 
